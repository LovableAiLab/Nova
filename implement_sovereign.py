...
print("🏗️ IMPLEMENTING SOVEREIGN ARCHITECT DESIGN...")
print("==============================================")
...
# Find where to insert (after hero section, before footer)
hero_end = content.find('</section>', content.find('nova-hero'))
footer_start = content.find('<footer class="nova-footer"')

if hero_end == -1 or footer_start == -1:
    print("❌ Could not find required sections")
    exit(1)

# Create Sovereign design
sovereign_design = '''
